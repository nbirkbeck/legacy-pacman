...
public:
  ...
  inline int canGo2(int visited[G_HEIGHT][G_WIDTH], int cutoff, int i, int j,
                    int dir);
  ...
  int limitedDFS(loc* target, loc* stack, int* instack, int* path, int* inpath,
                 int visited[G_HEIGHT][G_WIDTH], int cutoff);
